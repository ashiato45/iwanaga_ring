...
0を左に置いたときには、
\easypicture{1427795262217.png}
となる。

「$R$加群の可換図式で、
\begin{center}
  \begin{tikzcd}
    X_1 \ar[r, "\alpha_1"] \ar[d, "\varphi_1", two heads, hook] & X_2 \ar[r, "\alpha_2"] \ar[d, "\varphi_2", two heads, hook] & X_3 \ar[r] \ar[d, "\varphi_3"] & 0 \\
    Y_1 \ar[r, "\beta_1"] & Y_2 \ar[r, "\beta_2"] & Y_3 \ar[r] & 0
  \end{tikzcd}
\end{center}
...
\begin{myproof}
  ...
  \begin{center}
    \begin{tikzcd}
      X_1 \ar[r, "\alpha_1"] \ar[d, "\varphi_1", two heads, hook] & X_2 \ar[r, "\alpha_2", two heads] \ar[d, "\varphi_2", two heads, hook] & \cok(\alpha_1) \ar[r] \ar[d, "\varphi_3"] & 0 \\
      Y_1 \ar[r, "\beta_1"] & Y_2 \ar[r, "\beta_2", two heads] & \cok(\beta_1) \ar[r] & 0
    \end{tikzcd}
  \end{center}
  として一般性を失なわないことがわかった。
...
\item
\easypicture{1427821775969.png}
としておく。
\begin{itemize}
  \item $f_{32}$が全射:
  \easypicture{1427821910986.png}
  \item $\Image f_{31} \subset \ker f_{32}$:
  \easypicture{1427822011315.png}
  \item $\ker f_{32}\subset \Image f_{31}$:
  \easypicture{1427822169784.png}
  \item $f_{31}$が単射:
  \easypicture{1427823234042.png}
  ？
\end{itemize}
